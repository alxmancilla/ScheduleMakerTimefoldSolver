    ...
    private static List<Group> generateGroups() {
        ...
        groups.add(new Group("group_1C", "Grupo 1o C",
                Set.of("LENGUA Y COMUNICACIÓN I", "INGLÉS I", "PENSAMIENTO MATEMÁTICO I",
                        "CULTURA DIGITAL I", "LA MATERIA Y SUS INTERACCIONES", "HUMANIDADES I", "CIENCIAS SOCIALES I",
                        "RECURSOS SOCIOEMOCIONALES I", "TUTORIAS I", "CLUB DE AJEDREZ", "ACTIVACIÓN FÍSICA")));

...
INSERT INTO course (id, name, abbreviation,room_requirement,required_hours_per_week,semester,component,created_at,updated_at,active) VALUES
	 ('1','PENSAMIENTO MATEMATICO II','PENSAM. MATEM. II','estándar',4,2,'BASICAS',NOW(),NOW(),TRUE),
	 ('2','INGLES II','INGLES  II','estándar',3,2,'BASICAS',NOW(),NOW(),TRUE),
	 ('3','CIENCIAS NATURALES, EXPERIMENTALES Y TECNOLOGIA II. EL PODER DE LA ENERGIA.','CIEN NAT II','estándar',4,2,'BASICAS',NOW(),NOW(),TRUE),
	 ('4','LENGUA Y COMUNICACION II','LENGUA Y COM II','estándar',3,2,'BASICAS',NOW(),NOW(),TRUE),
	 ('5','CIENCIAS SOCIALES II','CIEN SOC II','estándar',2,2,'BASICAS',NOW(),NOW(),TRUE),
	 ('6','CULTURA DIGITAL II','CUL DIG II','estándar',2,2,'BASICAS',NOW(),NOW(),TRUE),
	 ('7','TUTORIAS II','TUTORIAS II','estándar',1,2,'BASICAS',NOW(),NOW(),TRUE),
	 ('8','EJECUTA PROCEDIMIENTOS ADMINISTRATIVOS DEL AREA DE RECURSOS HUMANOS','EJEC. PROC. ADM. A.R.H.','estándar',10,2,'TADRH',NOW(),NOW(),TRUE),
	 ('9','GESTIONA DOCUMENTACION DEL AREA DE RECURSOS HUMANOS','GEST. DOC. A.R.H.','estándar',7,2,'TADRH',NOW(),NOW(),TRUE),
	 ('10','DISEÑA PLANOS Y DIAGRAMAS ELECTRICOS Y ELECTRONICOS DE SISTEMAS ELECTROMECANICOS','DIS. PLA. DIAG. ELEC.SIST. ELEC.','taller electromecánica',4,2,'TEM',NOW(),NOW(),TRUE);
INSERT INTO course (id, name, abbreviation,room_requirement,required_hours_per_week,semester,component,created_at,updated_at,active) VALUES
	 ('11','REALIZA INSTALACIONES ELECTRICAS EN EQUIPOS ELECTROMECANICOS','REAL. INST. ELEC. EQU. ELEC.','taller electromecánica',9,2,'TEM',NOW(),NOW(),TRUE),
	 ('12','REALIZA INSTALACIONES DE CIRCUITOS ELECTRONICOS EN SISTEMAS ELECTROMECANICOS','REAL. INST. CIR. ELEC. SIST. ELEC.','taller electromecánica',4,2,'TEM',NOW(),NOW(),TRUE),
	 ('13','AUXILIA EN PROCEDIMIENTOS ADMINISTRATIVOS Y NORMATIVOS PARA IMPORTACIONES Y EXPORTACIONES DE MERCANCIAS','AUX. PROC.ADM. Y NOR. PARA IMPO. Y EXPOR. DE MERC.','estándar',10,2,'TCIA',NOW(),NOW(),TRUE),
	 ('14','VERIFICA LA DOCUMENTACION PARA LA IMPORTACION Y EXPORTACION DE MERCANCIAS','VER. LA DOC. PARA LA IMPOR. Y EXPORTACIÓN DE MERC.','estándar',7,2,'TCIA',NOW(),NOW(),TRUE),
	 ('15','REALIZA ANALISIS FISICOS Y QUIMICOS A LA MATERIA PRIMA','REA. ANA. FÍS. QUI. MAT. PRIMA','laboratorio',8,2,'TPIAL',NOW(),NOW(),TRUE),  -- Antes estándar
	 ('16','REALIZA ANALISIS MICROBIOLOGICOS A LA MATERIA PRIMA','REA. ANA. MICRO. MAT. PRIMA','laboratorio',9,2,'TPIAL',NOW(),NOW(),TRUE),  -- Antes taller
	 ('17','DISEÑA ALGORITMOS DE PROBLEMAS DE SEGURIDAD','DIS. ALGO.DE PROB. DE SEG.','centro de cómputo',6,2,'TCS',NOW(),NOW(),TRUE),
	 ('18','IMPLEMENTA SCRIPTS EN UN LENGUAJE DE PROGRAMACION PARA SOL DE PROB DE SEGURIDAD','IMPLE. SCRI. EN LENG. DE PROG. PARA LA SOL. DE PROB. DE SEG.','centro de cómputo',11,2,'TCS',NOW(),NOW(),TRUE),
	 ('19','DISEÑA SOFTWARE DE SISTEMAS INFORMATICOS','DIS. SOF. SIST. INFO.','centro de cómputo',5,2,'TPROG',NOW(),NOW(),TRUE),
	 ('20','CODIFICA SOFTWARE DE SISTEMAS INFORMATICOS','COD. SOF. SIST. INFO.','centro de cómputo',7,2,'TPROG',NOW(),NOW(),TRUE);
INSERT INTO course (id, name, abbreviation,room_requirement,required_hours_per_week,semester,component,created_at,updated_at,active) VALUES
	 ('21','IMPLEMENTA SOFTWARE DE SISTEMAS INFORMATICOS','IMP. SOF. SIST. INFO.','centro de cómputo',5,2,'TPROG',NOW(),NOW(),TRUE),
	 ('22','DESARROLLA ALGORITMOS PARA SOLUCIONAR PROBLEMAS','DES. ALG. PARA  SOLU. PROB.','centro de cómputo',9,2,'TIA',NOW(),NOW(),TRUE),
	 ('23','ELABORA PROYECTOS CON PROGRAMACION LOGICA','ELAB. PROY. CON PROG. LOGICA','centro de cómputo',8,2,'TIA',NOW(),NOW(),TRUE),
	 ('24','TEMAS SELECTOS DE MATEMATICAS I','TEM. SEL. MAT. I','estándar',4,4,'BASICAS',NOW(),NOW(),TRUE),
	 ('25','INGLES IV','INGLES IV','estándar',3,4,'BASICAS',NOW(),NOW(),TRUE),
	 ('26','CONCIENCIA HISTORICA I','CON. HIST. I','estándar',3,4,'BASICAS',NOW(),NOW(),TRUE),
	 ('27','REACCIONES QUIMICAS: CONSERVACION DE LA MATERIA EN LA FORMACION DE NUEVAS SUSTANCIAS','REACCIONES QUÍMICAS','estándar',4,4,'BASICAS',NOW(),NOW(),TRUE),
	 ('28','CIENCIAS SOCIALES III','CIEN. SOC. III','estándar',2,4,'BASICAS',NOW(),NOW(),TRUE),
	 ('29','RECURSOS SOCIOEMOCIONALES IV','REC. SOCIOEMO. IV','estándar',1,4,'BASICAS',NOW(),NOW(),TRUE),
	 ('30','TUTORIAS IV','TUTORIAS IV','estándar',1,4,'BASICAS',NOW(),NOW(),TRUE);
INSERT INTO course (id, name, abbreviation,room_requirement,required_hours_per_week,semester,component,created_at,updated_at,active) VALUES
	 ('31','GESTIONA LOS PROCESOS DE CAPACITACION PARA EL DESARROLLO DEL TALENTO HUMANO','GES. PROC. CAP. DES. T.H.','estándar',10,4,'TADRH',NOW(),NOW(),TRUE),
	 ('32','PROMUEVE CONDICIONES DE TRABAJO SALUDABLES EN LA ORGANIZACION','PROM. CON. TRAB. SAL. ORG.','estándar',7,4,'TADRH',NOW(),NOW(),TRUE),
	 ('33','REALIZA ANALISIS FISICOS, QUIMICOS Y MICROBIOLOGICOS EN CARNES Y SUS DERIVADOS','REAL. ANALISIS FÍS. QUÍ. MICRO.','laboratorio',6,4,'TPIAL',NOW(),NOW(),TRUE),  -- Antes taller
	 ('34','TRANSFORMA CARNE Y SUS DERIVADOS EN PRODUCTOS ALIMENTICIOS','REAL. PROC. TRANS. CARNICOS','taller',11,4,'TPIAL',NOW(),NOW(),TRUE),
	 ('35','MAQUINA PIEZAS MECANICAS EN TORNO Y FRESADORA CONVENCIONAL','MAQ. PZAS MEC. TOR FRES CONV.','taller electromecánica',6,4,'TEM',NOW(),NOW(),TRUE),
	 ('36','MAQUINA PIEZAS MECANICAS EN TORNO Y FRESADORA CNC','MAQ. PZAS MEC. TOR FRES CNC.','taller electromecánica',6,4,'TEM',NOW(),NOW(),TRUE),
	 ('37','CONSTRUYE ESTRUCTURAS METALICAS PARA LA INDUSTRIA','CON. EST. MET. INDUS.','taller electromecánica',5,4,'TEM',NOW(),NOW(),TRUE),
	 ('38','REALIZA MANTENIMIENTO A SISTEMAS ELECTRICOS DE POTENCIA','RLZA. MANTO. A SIST. ELEC. DE POTENCIA','taller electrónica',7,4,'TEC',NOW(),NOW(),TRUE),
	 ('39','PROGRAMA PLC PARA SISTEMAS AUTOMATIZADOS','PROG. PLC PARA SIS. AUTO.','taller electrónica',10,4,'TEC',NOW(),NOW(),TRUE),
	 ('40','IMPLEMENTA BASE DE DATOS RELACIONALES EN UN SISTEMA DE INFORMACION','IMP. BAS. DATOS REL. SIST. INF.','centro de cómputo',9,4,'TPROG',NOW(),NOW(),TRUE);
INSERT INTO course (id, name, abbreviation,room_requirement,required_hours_per_week,semester,component,created_at,updated_at,active) VALUES
	 ('41','IMPLEMENTA BASE DE DATOS NO RELACIONALES EN UN SISTEMA DE INFORMACION','IMP. BAS. DATOS NO REL. SIST. INF.','centro de cómputo',8,4,'TPROG',NOW(),NOW(),TRUE),
	 ('42','DETECTA VULNERABILIDADES EN SISTEMAS INFORMATICOS','DET. VULN. SIST. INFO.','centro de cómputo',10,4,'TCS',NOW(),NOW(),TRUE),
	 ('43','CORRIGE VULNERABILIDADES EN SISTEMAS INFORMATICOS','CORRIGE VULN. SIST. INFO.','centro de cómputo',8,4,'TCS',NOW(),NOW(),TRUE),
	 ('44','TEMAS SELECTOS DE MATEMATICAS III','TEMAS SELC. DE MAT.','estándar',5,6,'BASICAS',NOW(),NOW(),TRUE),
	 ('45','CONCIENCIA HISTÓRICA. LA REALIDAD ACTUAL EN PERSPECTIVA HISTORICA.','CONC. HIST. REAL ACT. PERSP HIST.','estándar',3,6,'BASICAS',NOW(),NOW(),TRUE),
	 ('46','HUMANIDADES III','HUM. III','estándar',5,6,'BASICAS',NOW(),NOW(),TRUE),
	 ('47','ORGANISMOS: ESTRUCTURAS Y PROCESOS. HERENCIA Y EVOLUCIÓN BIOLÓGICA','ORG. ESTRC. Y PROC. HERENCIA Y EVO. BIO.','estándar',4,6,'BASICAS',NOW(),NOW(),TRUE),
	 ('48','HUMANISMO Y PENSAMIENTO FILOSÓFICO EN MÉXICO','HUM Y PENS. FILOS. EN MEX.','estándar',3,6,'BASICAS',NOW(),NOW(),TRUE),
	 ('49','INTERACCIONES HUMANAS CON LA NATURALEZA','INTE. HUMA. CON LA NAT.','estándar',3,6,'BASICAS',NOW(),NOW(),TRUE),
	 ('50','TUTORIAS VI','TUTORIAS VI','estándar',1,6,'BASICAS',NOW(),NOW(),TRUE);
INSERT INTO course (id, name, abbreviation,room_requirement,required_hours_per_week,semester,component,created_at,updated_at,active) VALUES
	 ('51','AUXILIA EN EL CÁLCULO DE LA NOMINA ORDINARIA','AUX. EN EL CAL. DE LA NOM. ORD.','estándar',8,6,'TADRH',NOW(),NOW(),TRUE),
	 ('52','AUXILIA EN EL CÁLCULO DE LA NOMINA EXTRAORDINARIA','AUX. EN EL CAL. DE LA NOM. EXT.','estándar',4,6,'TADRH',NOW(),NOW(),TRUE),
	 ('53','REALIZA LOS ANÁLISIS FÍSICOS, QUÍMICOS Y MICROBIOLÓGICOS DE LOS PRODUCTOS DE CEREALES U OLEAGINOSAS Y PRODUCTOS DERIVADOS','REAL. ANAL FIS. QUIM. Y MICRO. DELOS PROD. DE CER. Y OLEAG. Y PROD. DERIV.','laboratorio',5,6,'TPIAL',NOW(),NOW(),TRUE),  --Antes taller
	 ('54','REALIZA LOS PROCESOS DE TRANSFORMACIÓN DE CEREALES Y PRODUCTOS DERIVADOS','REAL. PROC. DE TRANS. DE CER. Y PRO. DERV.','taller',7,6,'TPIAL',NOW(),NOW(),TRUE),
	 ('55','MANTIENE EQUIPOS HIDRAULICOS','MANT. EQUI. HIDR. ','taller electromecánica',4,6,'TEM',NOW(),NOW(),TRUE),
	 ('56','MANTIENE EQUIPOS NEUMATICOS','MANT. EQUI. NEUMATICOS','taller electromecánica',4,6,'TEM',NOW(),NOW(),TRUE),
	 ('57','MANTIENE EQUIPOS DE REFRIGERACION','MANT. EQUI. REFRIG.','taller electromecánica',4,6,'TEM',NOW(),NOW(),TRUE),
	 ('58','INSTALA SISTEMAS ELECTRONICOS DOMOTICOS','MANT. SIST. SEG. EDIFICIOS','taller electrónica',6,6,'TEC',NOW(),NOW(),TRUE),
	 ('59','INSTALA SISTEMAS ELECTRONICOS INDUSTRIALES AUTOMATIZADOS','IMP. SIST. AUTOMATIZADOS','taller electrónica',6,6,'TEC',NOW(),NOW(),TRUE),
	 ('60','DISEÑA APLICACIONES MOVILES MULTIPLATAFORMA','DIS. APP. MOVILES MULT.','centro de cómputo',5,6,'TPROG',NOW(),NOW(),TRUE),
	 ('61','IMPLEMENTA APLICACIONES MOVILES MULTIPLATAFORMA','IMPLE. APP. MOVILES MULT.','centro de cómputo',7,6,'TPROG',NOW(),NOW(),TRUE),
	 ('62','RECURSOS SOCIOEMOCIONALES VI','REC. SOCIOEMO. VI','estándar',1,6,'BASICAS',NOW(),NOW(),TRUE);
